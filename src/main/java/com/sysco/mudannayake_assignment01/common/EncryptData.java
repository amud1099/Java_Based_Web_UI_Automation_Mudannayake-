...
import com.sysco.mudannayake_assignment01.exception.EncryptionRuntimeException;
...
public class EncryptData {
        ...
        public static final byte[] INITIALIZATION_VECTOR_BYTES = new byte[]{87, -77, 121, 71, 39, -7, -78, 32, 51, -27, 37, -27, 60, 113, -23, -20};
        ...
        private static Cipher getCipher() {
            try {
                ...
                throw new EncryptionRuntimeException("Unable to getCipher", e);
            }
        }
        ...
        private static byte[] getBytesWith(int encryptMode, byte[] textBytes, IvParameterSpec initializationVectorSpec) {
            ...
            try {
                ...
                throw new EncryptionRuntimeException("Unable to encrypt", e);
            }
